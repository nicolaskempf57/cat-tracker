...
from flask_babel import format_date, _
from flask_login import current_user, login_user, logout_user, login_required
from werkzeug.urls import url_parse

from app import Q_, ureg, get_locale, app, db
...
def user(username):
    ...
    cats = [
        {'owner': user, 'name': 'Test cat #1'},
        {'owner': user, 'name': 'Test cat #2'}
    ]
    return render_template('user.html', user=user, cats=cats)
